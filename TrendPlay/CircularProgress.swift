...
//  TrendPlay
//
//  Created by Chelsea Smith on 10/4/18.
//  Copyright © 2018 Trending Productions LLC. All rights reserved.
//
...
class CircularProgress: UIView {
    ...
    var trackColor:UIColor = UIColor.white {
     ...
     /*func createCircularPath() {
        ...
        progressLayer.strokeColor = orangeColorDarkerCG //progressColor.cgColor
